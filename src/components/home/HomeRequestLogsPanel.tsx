        ...
        className={cn(
          ...
          isSelected
            ...
            : auditMeta.muted
              ...
              : "bg-white/80 border-border/60 hover:bg-secondary/80 hover:border-border/60 hover:shadow-[0_2px_8px_rgba(15,23,42,0.06)] dark:bg-secondary/80 dark:border-border/60 dark:hover:bg-slate-750/80 dark:hover:border-border/60 dark:hover:shadow-[0_2px_8px_rgba(0,0,0,0.2)]"
        )}
      >
        {/* Selection indicator */}
        <div
