...
macro_rules! generated_command_registry {
    ($callback:ident) => {
        $callback! {
            ...
            gateway_session_pin_sort_mode => crate::commands::gateway::gateway_session_pin_sort_mode,
            gateway_session_unpin_sort_mode => crate::commands::gateway::gateway_session_unpin_sort_mode,
            gateway_session_persist_sort_mode => crate::commands::gateway::gateway_session_persist_sort_mode,
            gateway_session_unpersist_sort_mode => crate::commands::gateway::gateway_session_unpersist_sort_mode,
            gateway_persistent_pins_list => crate::commands::gateway::gateway_persistent_pins_list,
            ...
            cli_sessions_metadata_lookup_by_ids => crate::commands::cli_sessions::cli_sessions_metadata_lookup_by_ids,
            // ── data_management ──
