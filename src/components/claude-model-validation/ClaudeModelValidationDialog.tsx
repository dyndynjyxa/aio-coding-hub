    ...
    >
      {!provider ? (
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between rounded-2xl border border-slate-200/60 dark:border-border/60 bg-white/50 dark:bg-slate-900/30 px-5 py-4 text-sm shadow-sm backdrop-blur-md">
            <div className="flex flex-wrap items-center gap-6 text-secondary">
              ...
              <div className="hidden h-10 w-px bg-slate-200 dark:bg-secondary sm:block" />
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="inline-flex items-center rounded-md bg-slate-100/80 dark:bg-secondary px-2 py-0.5 text-xs font-medium text-slate-600 dark:text-secondary ring-1 ring-inset ring-border">
          ...
          {/* Form Bar */}
          <div className="grid gap-5 rounded-2xl border border-slate-200/60 dark:border-border/60 bg-slate-50/40 dark:bg-secondary/40 p-5 sm:grid-cols-12 shadow-sm">
            ...
            <div className="flex items-end gap-2 sm:col-span-4">
              <FormField label="轮数" className="w-20 shrink-0">
                <input
                  ...
                  disabled={validating}
                  className="h-10 w-full rounded-md border border-border bg-white/80 dark:bg-slate-900/80 px-3 text-xs font-mono text-center shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                />
              </FormField>
              <Button
