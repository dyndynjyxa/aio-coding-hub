...
export function ClaudeModelSection(props: { form: UseProviderEditorFormReturn }) {
  ...
  return (
    <details className="group rounded-xl border border-slate-200 bg-white shadow-sm open:ring-2 open:ring-accent/10 transition-all dark:border-border dark:bg-secondary">
      <summary className="flex cursor-pointer items-center justify-between px-4 py-3 select-none">
        <div className="flex items-center gap-3">
          <span className="text-sm font-medium text-slate-700 group-open:text-accent dark:text-secondary">
            {sectionTitle}
          </span>
      ...
      <div className="space-y-4 border-t border-slate-100 px-4 py-3 dark:border-border">
        <FormField
          label="主模型"
