...
function makeRequestLog(
  ...
  return {
    ...
    cost_multiplier: partial.cost_multiplier ?? 1,
    created_at_ms: partial.created_at_ms ?? null,
    created_at: partial.created_at ?? 0,
  };
}
  ...
  it("sorts OAuth providers by recent usage from request logs", async () => {
    ...
    const requestLogs: RequestLogSummary[] = [
      makeRequestLog({
        ...
        route: [{ provider_id: 11, provider_name: "Codex OAuth", ok: true, status: 200 }],
        created_at_ms: 1_000,
        created_at: 1,
      }),
      makeRequestLog({
        ...
        route: [{ provider_id: 22, provider_name: "Gemini OAuth", ok: true, status: 200 }],
        created_at_ms: 2_000,
        created_at: 2,
      }),
    ];
