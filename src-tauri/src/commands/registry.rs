...
macro_rules! generated_command_registry {
    ($callback:ident) => {
        $callback! {
            ...
            cli_manager_gemini_settings_json_get => crate::commands::cli_manager::cli_manager_gemini_settings_json_get,
            cli_manager_gemini_settings_json_validate => crate::commands::cli_manager::cli_manager_gemini_settings_json_validate,
            cli_manager_gemini_settings_json_set => crate::commands::cli_manager::cli_manager_gemini_settings_json_set,
            ...
            cli_manager_claude_settings_json_get => crate::commands::cli_manager::cli_manager_claude_settings_json_get,
            cli_manager_claude_settings_json_validate => crate::commands::cli_manager::cli_manager_claude_settings_json_validate,
            cli_manager_claude_settings_json_set => crate::commands::cli_manager::cli_manager_claude_settings_json_set,
