...
function Cx2ccGatewaySourceInfo(props: {
  ...
  return (
    <div className="rounded-md border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs text-slate-500 dark:border-border dark:bg-secondary/50 dark:text-muted-foreground">
      <p>
        已选择
        <span className="mx-1 font-medium text-slate-700 dark:text-foreground">
          当前 AIO 服务 Codex 网关
        </span>
      </p>
      <div className="mt-1 flex flex-wrap gap-x-3 gap-y-1 text-[11px] leading-5">
        <span>
          认证：
          <span className="ml-1 text-slate-700 dark:text-foreground">App Token</span>
        </span>
        <span>
          价格倍率：
          <span className="ml-1 font-mono text-slate-700 dark:text-foreground">免费</span>
        </span>
        <span className="min-w-0 max-w-full truncate" title={codexGatewayBaseUrl}>
          Base URL：
          <span className="ml-1 font-mono text-slate-700 dark:text-foreground">
            {codexGatewayBaseUrl}
          </span>
        </span>
        <span>
  ...
  return (
    <div className="rounded-md border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs text-slate-500 dark:border-border dark:bg-secondary/50 dark:text-muted-foreground">
      ...
      <div className="mt-1 flex flex-wrap gap-x-3 gap-y-1 text-[11px] leading-5">
        <span>
          认证：
          <span className="ml-1 text-slate-700 dark:text-foreground">
...
function Cx2ccFallbackModelsInfo(props: {
  ...
  return (
    <p className="mt-1 text-[11px] leading-5">
      当前模型映射： 主模型
      <span className="mx-1 font-mono text-slate-700 dark:text-foreground">
