...
const SETTINGS_VIEW_TO_UPDATE_FIELD_MAP = {
  ...
  routerModeEnabled: "router_mode_enabled",
  routerModeMaxRounds: "router_mode_max_rounds",
...
function toGeneratedSettingsUpdate(input: SettingsSetInput): GeneratedSettingsUpdate {
  const update: GeneratedSettingsUpdate = {
    ...
    routerModeEnabled: input.routerModeEnabled ?? null,
    routerModeMaxRounds: input.routerModeMaxRounds ?? null,
