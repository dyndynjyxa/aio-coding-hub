      ...
      <div className="min-h-0 flex-1 overflow-y-auto scrollbar-overlay">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:items-start">
          <SettingsMainColumn
            ...
            enableAssociationAudit={persistence.enableAssociationAudit}
            setEnableAssociationAudit={persistence.setEnableAssociationAudit}
            associationAuditProviderId={persistence.associationAuditProviderId}
            setAssociationAuditProviderId={persistence.setAssociationAuditProviderId}
            associationAuditModel={persistence.associationAuditModel}
            setAssociationAuditModel={persistence.setAssociationAuditModel}
            associationAuditMode={persistence.associationAuditMode}
            setAssociationAuditMode={persistence.setAssociationAuditMode}
            associationAuditSampleRate={persistence.associationAuditSampleRate}
            setAssociationAuditSampleRate={persistence.setAssociationAuditSampleRate}
            associationAuditTimeoutSeconds={persistence.associationAuditTimeoutSeconds}
            setAssociationAuditTimeoutSeconds={persistence.setAssociationAuditTimeoutSeconds}
            associationAuditMaxInputChars={persistence.associationAuditMaxInputChars}
            setAssociationAuditMaxInputChars={persistence.setAssociationAuditMaxInputChars}
            associationAuditMaxOutputChars={persistence.associationAuditMaxOutputChars}
            setAssociationAuditMaxOutputChars={persistence.setAssociationAuditMaxOutputChars}
